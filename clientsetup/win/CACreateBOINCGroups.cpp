...
public:
    virtual ~CACreateBOINCGroups() = default;
    ...
    UINT OnExecution() override final {
        ...
        wil::unique_sid pAdminSID(
            static_cast<PSID>(LocalAlloc(LMEM_FIXED, sidSize)));
        CopySid(sidSize, pAdminSID.get(),
        ...
        lgrpiProjects.lgrpi1_comment =
            _T("Accounts in this group are used to execute "
                "boinc applications.");
        ...
        if (bBOINCAdminsCreated || bBOINCUsersCreated ||
            bBOINCProjectsCreated) {
            RebootWhenFinished();
        }
