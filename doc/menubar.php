...
page_head("BOINC Menubar 4.25 (v2)");
...
<p> <img src=screenshots/menu.jpg width=290 height=426><br>
  (Figure 1)
...
<h3>Returning BOINC Participants</h3>
 <p> If you already have a BOINC account and have run the 'boinc' command on this computer, you will need to move existing files to a new location. Locate the folder which served as the launch path when you ran the 'boinc' command. It should contain such files and folders as 'client_state.xml', 'slots', and 'projects'.
...
<p> <img src=screenshots/menuMouseOnManageProjects.jpg width=292 height=425><br>
 (Figure 2)
...
<p> The 'Current Project' is simply the project which is currently being run by BOINC. The current project will change from time to time as BOINC stops and starts other projects.
<p> The 'Work Completed' indicates what percentage of the current work unit has been completed.
...
<p> The 'Total Credit' is the amount of credit you have received for all projects which BOINC Menubar knows about. That is, if you are participating in four projects on this computer, then the total credit will be the sum of all four project credits.
  ...
  <h2>&nbsp;</h2>
<h1>Preferences</h1>
<p> <img src=screenshots/preferencesWindow.jpg width=525 height=268><br>
  (Figure 8)
...
<p> Select 'Display Log On Application Launch' if you wish the Log window to open automatically every time you open BOINC Menubar.
  
<p> Select Unlimited Scrollback if you would like to keep all the output produced by BOINC. By default, the BOINC Menubar keeps the last 10,000 lines output by BOINC.
</p>
<p>&nbsp;</p>
...
<p><strong>Note:</strong> BOINC Menubar currently does not hide your password. Therefore, it will be visible when you type it. </p>
<p><img src=screenshots/preferencesWindowWithProxyPasswordSheet.jpg width=524 height=268><br>
(Figure 9)</p>
<p>Click &quot;OK&quot; to save</p>
<p>&nbsp;</p>
<h1>Acknowledgements and Support</h1>
<p> BOINC Menubar was developed by <a href=http://www.greenkeepersoftware.com>GreenKeeper Software</a>, which has made BOINC Menubar freely available for BOINC participants. If you wish, you can make a <a href=http://www.greenkeepersoftware.com/donate.html>donation</a> to GreenKeeper Software to support further development of BOINC Menubar and future GreenKeeper Software products.
