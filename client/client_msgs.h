...
struct MESSAGE_DESCS {
    ...
    void insert(struct PROJ_AM *p, int priority, int now, char* msg);
...
extern void msg_printf(struct PROJ_AM *p, int priority, const char *fmt, ...)
...
//
extern void msg_printf_notice(struct PROJ_AM *p, bool is_html, const char* link, const char *fmt, ...)
