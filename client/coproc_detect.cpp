...
void COPROC_NVIDIA::get(
    ...
    for (j=0; j<cuda_ndevs; j++) {
        ...
        (*__cuDeviceGetAttribute)(&cc.prop.pciBusID, CU_DEVICE_ATTRIBUTE_PCI_BUS_ID, device);
        (*__cuDeviceGetAttribute)(&cc.prop.pciDeviceID, CU_DEVICE_ATTRIBUTE_PCI_DEVICE_ID, device);
        (*__cuDeviceGetAttribute)(&cc.prop.pciDomainID, CU_DEVICE_ATTRIBUTE_PCI_DOMAIN_ID, device);
