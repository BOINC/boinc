...
export CFLAGS="--sysroot=$TCSYSROOT -DANDROID -D__ANDROID_API__=14 -Wall -I$TCINCLUDES/include -O3 -fomit-frame-pointer -fPIE -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16"
