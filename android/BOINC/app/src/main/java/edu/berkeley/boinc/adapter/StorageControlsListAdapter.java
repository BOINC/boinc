...
import edu.berkeley.boinc.StorageFragment.StorageControl;
import edu.berkeley.boinc.R;
import edu.berkeley.boinc.StorageFragment;
import edu.berkeley.boinc.rpc.RpcClient;

public class StorageControlsListAdapter extends ArrayAdapter<StorageControl> {
    private List<StorageControl> entries; // ID of control texts in strings.xml
    private Activity activity;

    public StorageControlsListAdapter(Activity activity, ListView listView, int layoutId, List<StorageControl> entries) {
    ...
    @Override
    public StorageControl getItem(int position) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        StorageControl data = entries.get(position);
        ...
        switch(data.operation) {
            ...
            case RpcClient.TRANSFER_RETRY:
                ...
                break;
            case StorageControl.VISIT_WEBSITE:
