...
class IndividualCredentialInputFragment : DialogFragment() {
    ...
    private lateinit var forgotPwdLink: String
    private lateinit var project: ProjectAttachWrapper
    ...
    override fun onCreateView(
        ...
        binding!!.registerButton.setOnClickListener { view ->
            ...
            if (project.config!!.clientAccountCreationDisabled) {
                ...
                i.data = Uri.parse(project.config!!.masterUrl)
                startActivity(i)
            } else {
                val email = binding!!.emailInput.text.toString()
                val name = binding!!.nameInput.text.toString()
        ...
        binding!!.forgotPwdButton.setOnClickListener { view ->
            ...
            val i = Intent(Intent.ACTION_VIEW)
            i.data = Uri.parse(forgotPwdLink)
            startActivity(i)
        }
