...
export CXXFLAGS="--sysroot=$TCSYSROOT -DANDROID -D__ANDROID_API__=16 -Wall -isystem $TCINCLUDES/4.9.x/include -I$TCINCLUDES/include -I$TCINCLUDES/4.9.x/include -funroll-loops -fexceptions -O3 -fomit-frame-pointer -fPIE -march=armv7-a"
