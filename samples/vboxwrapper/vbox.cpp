...
int VBOX_VM::get_system_log(string& log, bool tail_only, unsigned int buffer_size) {
...
int VBOX_VM::get_vm_log(string& log, bool tail_only, unsigned int buffer_size) {
    string slot_directory;
...
int VBOX_VM::get_trace_log(string& log, bool tail_only, unsigned int buffer_size) {
    string slot_directory;
    string vm_trace_log;
    string::iterator iter;
    int retval = BOINC_SUCCESS;
