...
if [ "${gtest_only}" = "yes" ]; then
    download_and_build "googletest-release-1.10.0" "release-1.10.0.tar.gz" "https://github.com/google/googletest/archive/release-1.10.0.tar.gz" "${ROOTDIR}/3rdParty/buildGoogletestLinux.sh"
else
