...
<h3>".tra("Privacy policy")."</h3>
    ...
    <p>".tra("Private messages sent on the %1 web site are visible only to the sender and recipient.  %1 does not examine or police the content of private messages.  If you receive unwanted private messages from another %1 user, you may add them to your message filter <a href=edit_forum_preferences_form.php>here</a>.  This will prevent you from seeing any public or private messages from that user.", PROJECT)."
    <p>".tra("If you use our web site forums you must follow the posting guidelines listed <a href=moderation.php>here</a>.  Messages posted to the %1 forums are visible to everyone, including non-members.  By posting to the forums, you are granting irrevocable license for anyone to view and copy your posts.", PROJECT)."
