...
if (get_str('action')=="start") {
    ...
    row1(tra("Are you sure you want to banish %1 ?<br/>This will prevent %1 from posting for chosen duration.<br/>It should be done only if %1 has consistently violated message board rules.", $user->name));
    row2("",
