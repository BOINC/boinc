...
namespace test_boinccas_CAGrantBOINCMasterRights {
    constexpr auto userName = "boinc_master";
    constexpr auto userPassword = "qwerty123456!@#$%^";

    class test_boinccas_CAGrantBOINCMasterRights :
        public test_boinccas_TestBase {
    protected:
        test_boinccas_CAGrantBOINCMasterRights() :
            test_boinccas_TestBase("GrantBOINCMasterRights") {
        }
    ...
    TEST_F(test_boinccas_CAGrantBOINCMasterRights,
