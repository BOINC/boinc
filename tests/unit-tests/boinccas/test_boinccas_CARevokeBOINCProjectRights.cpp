...
namespace test_boinccas_CARevokeBOINCProjectRights {
    constexpr auto userName = "boinc_project";
    constexpr auto userPassword = "qwerty123456!@#$%^";

    class test_boinccas_CARevokeBOINCProjectRights :
        public test_boinccas_TestBase {
    protected:
        test_boinccas_CARevokeBOINCProjectRights() :
            test_boinccas_TestBase("RevokeBOINCProjectRights") {
        }
...
#ifdef BOINCCAS_TEST
    TEST_F(test_boinccas_CARevokeBOINCProjectRights, NoUser_Expect_Fail) {
    ...
    TEST_F(test_boinccas_CARevokeBOINCProjectRights,
