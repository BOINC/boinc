...
namespace test_boinccas_CAGrantBOINCUsersRights {
    constexpr auto groupName = "boinc_users";
    class test_boinccas_CAGrantBOINCUsersRights :
        public test_boinccas_TestBase {
    protected:
        test_boinccas_CAGrantBOINCUsersRights() :
            test_boinccas_TestBase("GrantBOINCUsersRights") {
        }
...
#ifdef BOINCCAS_TEST
    TEST_F(test_boinccas_CAGrantBOINCUsersRights, NoGroup_Expect_Fail) {
    ...
    TEST_F(test_boinccas_CAGrantBOINCUsersRights,
