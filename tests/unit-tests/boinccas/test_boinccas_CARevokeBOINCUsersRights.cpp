...
namespace test_boinccas_CARevokeBOINCUsersRights {
    constexpr auto groupName = "boinc_users";
    class test_boinccas_CARevokeBOINCUsersRights :
        public test_boinccas_TestBase {
    protected:
        test_boinccas_CARevokeBOINCUsersRights() :
            test_boinccas_TestBase("RevokeBOINCUsersRights") {
        }
...
#ifdef BOINCCAS_TEST
    TEST_F(test_boinccas_CARevokeBOINCUsersRights, NoGroup_Expect_Fail) {
    ...
    TEST_F(test_boinccas_CARevokeBOINCUsersRights,
