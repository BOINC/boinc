...
namespace test_boinccas_CAGrantBOINCProjectsVirtualBoxRights {
    ...
    class test_boinccas_CAGrantBOINCProjectsVirtualBoxRights :
        public test_boinccas_TestBase {
    protected:
        test_boinccas_CAGrantBOINCProjectsVirtualBoxRights() :
            test_boinccas_TestBase("GrantBOINCProjectsVirtualBoxRights") {
        }
    ...
    TEST_F(test_boinccas_CAGrantBOINCProjectsVirtualBoxRights,
        NoBoincProjectsGroup_ExpectFail) {
    ...
    TEST_F(test_boinccas_CAGrantBOINCProjectsVirtualBoxRights,
        BoincProjectsGroupExists_SingleRunSuccess) {
        const auto result = openMsi();
        ASSERT_EQ(0u, result);
