...
class IntegrationTests:
    ...
    def test_files_exist(self):
        ...
        ts.expect_true(os.path.exists("/usr/local/share/applications/boinc.desktop"), "Test 'boinc.desktop' file exists in '/usr/share/applications/'")
        ts.expect_true(os.path.exists("/usr/local/share/icons/boinc/boinc.png"), "Test 'boinc.png' file exists in '/usr/local/share/icons/boinc/'")
        ts.expect_true(os.path.exists("/usr/local/share/icons/boinc/boinc.svg"), "Test 'boinc.svg' file exists in '/usr/local/share/icons/boinc/'")
