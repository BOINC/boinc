...
#ifdef __WXMAC__
    m_pConfig->Read(wxT("DisplayMenuBarExtra"), &m_iDisplayMenuBarExtra, 1L);
#endif
...
#ifdef __WXMAC__
    m_pConfig->Write(wxT("DisplayMenuBarExtra"), m_iDisplayMenuBarExtra);
#endif
