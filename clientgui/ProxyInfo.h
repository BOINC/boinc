...
#pragma interface "ProxyInfo.cpp"
#endif

#include "XMLParser.h"


class CProxyInfo : public CXMLParser
{
    DECLARE_DYNAMIC_CLASS(CProxyInfo)
...
private:
    ...
    wxString        http_server_password;
    bool            use_socks_proxy;
    wxInt32         socks_version;
    wxString        socks_server_name;
    wxInt32         socks_server_port;
    wxString        socks_server_username;
    wxString        socks_server_password;
