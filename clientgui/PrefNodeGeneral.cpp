...
#pragma implementation "PrefNodeGeneral.h"
#endif
...
IMPLEMENT_DYNAMIC_CLASS(CPrefNodeGeneral, CPrefNodeBase)

CPrefNodeGeneral::CPrefNodeGeneral(wxWindow* parent, GLOBAL_PREFS* preferences)
: CPrefNodeBase(parent, preferences) {

    CPrefGroup* work = AddGroup(_("Work Buffer"));
    ...
    switching->AddPreference(new CPrefValueText(this,
